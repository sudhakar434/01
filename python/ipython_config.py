...
c.InteractiveShellApp.exec_files = [os.path.join(home, '.01/python/ipy_init.py')]
...
# c.InteractiveShell.banner1 = 'Python 3.5.2 (default, Jul  5 2016, 12:43:10) \nType "copyright", "credits" or "license" for more information.\n\nIPython 5.0.0 -- An enhanced Interactive Python.\n?         -> Introduction and overview of IPython\'s features.\n%quickref -> Quick reference.\nhelp      -> Python\'s own help system.\nobject?   -> Details about \'object\', use \'object??\' for extra details.\n'
...
# The name of a Pygments style to use for syntax highlighting:  native,
# friendly, paraiso-dark, perldoc, lovelace, tango, default, borland, pastie,
# trac, igor, vs, fruity, vim, murphy, monokai, autumn, emacs, algol, manni,
# paraiso-light, algol_nu, bw, colorful, xcode, rrt
